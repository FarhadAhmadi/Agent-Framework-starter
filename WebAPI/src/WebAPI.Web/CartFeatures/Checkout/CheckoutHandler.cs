...
using WebAPI.Web.Domain.CartAggregate.Specifications;
using WebAPI.Web.Domain.GuestUserAggregate;
using WebAPI.Web.Domain.GuestUserAggregate.Specifications;
using WebAPI.Web.Domain.OrderAggregate;
using WebAPI.Web.Domain.ProductAggregate;

namespace WebAPI.Web.CartFeatures.Checkout;
